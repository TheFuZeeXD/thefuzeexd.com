...
import Discord_icon from "/image/icons/discord_icon.png"
    ...
    return( 
        <div id="Contact">
            ...
            <div className="form_contact">
                <form method="POST" action="/security/m/verify_email.php">
                    <label htmlFor="mail">Введите свой эл.почту</label>
                    <input type="email" name="mail" id="inpt" placeholder="example@example.com"/>
                    <label htmlFor="description">Описание</label>
                     <textarea placeholder="Я такой то такой то"/>
            ...
            <div className="info_contact">
                ...
                <ul>
                    ...
                    <a href="https://discord.com/oauth2/authorize?client_id=1429847066863210568"><img src={Discord_icon} alt="" />Discord</a>
